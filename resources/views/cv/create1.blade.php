                ...
                <div class="col-md-12 border-right content-left">
                    <div class="p-3 py-2">
                        ...
                        <div id="8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">   
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <span id="btnfile" for="#getFile" class="border px-3 p-1 add-button" onclick="document.getElementById('getFile').click()">
                                            Chosse Image
                                            <input type="file" name="image_profile" id="getFile" class="form-control form-control-sm" accept=".png, .jpg, .jpeg, .svg, .bmp" hidden>
                                        </span>
                                        <img id="Dimage" class="img-thumbnail" width="125" src="" alt="Image Principale" >
                            ...
                            <div class="row">
                                <div class="col-md-6 py-1">
                                    ...
                                    <input type="date" id="date_birth" name="date_birth" min="{{ date('Y-m-d', strtotime('-60 years'))}}" max="{{ date('Y-m-d', strtotime('-15 years'))}}" class="form-control" value="{{ old('date_birth') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 py-1">
                                    ...
                                    <select class="form-select" id="situation" name="situation_family">
                            ...
                            <div class="col-md-6 py-1">
                                ...
                                <input type="text" id="hobbies" name="hobbies" class="form-control" placeholder="for exmple: Sport, Cinema, Cooking, Music" value="{{ old('hobbies') }}">
                                <span style="color:red;">@error('hobbies'){{ $message }} @enderror</span>
                            </div>

                            <div class="form-group py-1">
                                <label for="">Profile</label>
                                <textarea type="text-area" id="my_profile" name="my_profile" class="form-control" placeholder="talk about your self" rows="2">{{ old('my_profile') }}</textarea>
                        ...
                        <div id="22" style="display: none;">
                            ...
                            <div class="row">
                                <div class="col-md-6 py-2"><label class="labels">Address</label><input id="address" type="text" name="address" class="form-control contact" pattern="^[a-zA-Z0-9 -+°]{5,60}" value="{{old('address')}}" ><span style="color:red;">@error('address'){{ $message }} @enderror</span></div>
                                <div class="col-md-6 py-2"><label class="labels">City</label><input type="text" id="Adcity" name="city" class="form-control contact" pattern="^[a-zA-Z ]{3,20}" value="{{old('city')}}" minlength="3" maxlength="20"><span style="color:red;">@error('city'){{ $message }} @enderror</span></div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 py-1"><label class="labels">Phone 1</label><input type="text" id="phone1" name="phone1" class="form-control contact" pattern="^[0-9 ()-,+]{10,13}$" value="{{old('phone1')}}" minlength="10" maxlength="13"><span style="color:red;">@error('phone1'){{ $message }} @enderror</span></div>
                                <div class="col-md-6 py-1"><label class="labels">Phone 2</label><input type="text" id="phone2" name="phone2" class="form-control contact" pattern="^[0-9 ()-,+]{10,13}$" value="{{old('phone2')}}" minlength="10" maxlength="13"><span style="color:red;">@error('phone2'){{ $message }} @enderror</span></div>
                            </div>
                            <div class="col-md-12 py-1"><label class="labels">Email</label><input type="text" id="email" name="email" class="form-control contact" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" value="{{old('email')}}" minlength="5" maxlength="35"><span style="color:red;">@error('email'){{ $message }} @enderror</span></div>
                            <div class="col-md-12 py-1"><label class="labels">Linkedin</label><input type="text" id="linkedin" name="linkedin" class="form-control contact" value="{{old('linkedin')}}" maxlength="70" placeholder="www.linkedin.com/in/name-lastname"><span style="color:red;">@error('linkedin'){{ $message }} @enderror</span></div>
                        </div> 
                                                ...
                                                <div class="fnXcmN @if($errors->has('certificate.'.$i) || $errors->has('institute_name.'.$i) || $errors->has('Specialty_name.'.$i) || $errors->has('date_obtaining.'.$i) || $errors->has('description.'.$i)) border rounded border-danger @endif">
                                                    ...
                                                    <div class="set">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 py-1"><label class="labels">Date Obtaining</label><select name="date_obtaining[]" value="{{ old('date_obtaining.'.$i) }}" class= "form-control date_ob input_etu{{$i+1}}"><option selected value="{{ old('date_obtaining.'.$i) }}">{{ old('date_obtaining.'.$i)}}</option></select><span style="color:red;">@error('date_obtaining.'.$i){{ $message }} @enderror</span></div>
                                                        </div>
                                                        <div class="col-md-12 py-1"><label class="labels">Description</label><textarea name="description[]"  maxlength="130" class ="form-control other_info">{{ old('description.'.$i) }}</textarea><span style="color:red;">@error('description.'.$i){{ $message }} @enderror</span></div>
                                                    </div>
                                            ...
                                            @foreach(old('namJob') as $input)
                                                <div class="fnXcmN @if($errors->has('namJob.'.$exp) || $errors->has('institution.'.$exp) || $errors->has('startdate.'.$exp) || $errors->has('enddate.'.$exp) || $errors->has('city_exp.'.$exp) || $errors->has('otherinfo.'.$exp)) border rounded border-danger @endif">
                                                    ...
                                                    <div class="set" id="showEtu">
                                                        ...
                                                        <div class="col-md-12 py-1"><label class="labels">Description</label><textarea name="otherinfo[]" maxlength="120" class = "form-control">{{ old('otherinfo.'.$exp) }}</textarea><span style="color:red;">@error('otherinfo.'.$exp){{ $message }} @enderror</span></div>
                                                    </div>   
                                                    <div class="dxqSpv"></div>         
                                                </div>
                                                @php($exp++)
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#download").click(function() {
            /* axios.post("{{route('download')}}",{
            html : $('#cv_templet').contents().find('#resulta').html(),
            })
        ...
        axios({
            ...
            /* data : { html : $('#cv_templet').contents().find('#resulta').html()}, */
                ...
                fileLink.setAttribute('download', 'cv-download.pdf');
